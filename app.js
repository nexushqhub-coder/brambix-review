...
loadEscalations();
// No timer-based polling, to conserve n8n execution quota.
// Instead, refresh automatically only when you return to this tab/app
// (e.g. switching back from another app, or reopening after it was backgrounded).
document.addEventListener('visibilitychange', () => {
  if (document.visibilityState === 'visible') loadEscalations();
});
